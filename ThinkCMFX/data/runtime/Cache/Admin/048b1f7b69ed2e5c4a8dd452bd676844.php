...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Question/true');?>">真题管理</a></li>
			<li><a href="<?php echo U('Question/trueadd');?>">真题添加</a></li>
			<li class="active"><a href="<?php echo U('Question/truesubjectivelist');?>">主观题列表</a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('Question/truesubjectivelist');?>">
			 题干： 
		...
		<form class="js-ajax-form" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($item)): foreach($item as $key=>$vo): ?><tr>
					...
					<td><?php echo ($vo["eid"]); ?>年国家司法考试试题</td>
					<td><?php echo (date('Y-m-d H:i:s',$vo["itime"])); ?></td>
					<td>
						主观题
					</td>
					<td>
						<a href="<?php echo U('Question/truesubjectiveedit',array('sub_id'=>$vo['sub_id']));?>"><?php echo L('EDIT');?></a>|
