...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo U('Question/exclusiveadd');?>"  target="_self">密卷添加</a></li>
    <li><a href="<?php echo U('Question/exclusivemater');?>">添加密卷材料题</a></li>
    <li><a href="<?php echo U('Question/exclusivesubjective');?>">添加密卷主观题</a></li>
</ul>
<form class="form-horizontal js-ajax-form" action="<?php echo U('Question/exclusiveadd_post');?>" method="post">
    ...
    <div class="table_full">
        <table width="100%" cellpadding="2" cellspacing="2">
            <!-- <tr>
                <th width="80">试卷名称</th>
                <td>
                    <input type="text" name="eid" value="" style="width: 100px"/>年国家司法考试试题
                </td>
            </tr> -->
            <tr>
                <th width="80">密卷科目</th>
                <td>
                   <select name="ex_id" class="normal_select">
                         <?php if(is_array($exc)): foreach($exc as $key=>$vo): ?><option value="<?php echo ($vo["ex_id"]); ?>"><?php echo ($vo["etitle"]); ?></option><?php endforeach; endif; ?>
                   </select>
                </td>
            </tr>
             <tr>
			 ...
			 <tr>
                <th width="80">题号</th>
                <td>
                    <input type="text" name="no" value="" style="width: 100px"/>
                </td>
            </tr>
            <tr>
                <th width="80">题干</th>
            ...
            <tr>
                <th width="80">选项</th>
                <td>
                    <textarea name='options' autocomplete="off" id='e_answer' style='width:98%;height:150px;'></textarea>A,B,C,D各个选项用英文';'隔开
                </td>
            </tr>
            ...
            <tr>
                <th width="80">考点</th>
                <td>
                    <input type="text" autocomplete="off" value="" name="point" style='width:98%;' />
                </td>
            </tr>
            <tr>
             <th width="80">难易度</th>
