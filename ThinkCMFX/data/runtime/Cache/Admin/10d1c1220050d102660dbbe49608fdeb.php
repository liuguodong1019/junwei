...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
	        <li class="active"><a href="#A" data-toggle="tab">密卷添加</a></li>
	    </ul>
		<form class="form-horizontal js-ajax-form" action="<?php echo U('Types/exclusiveadd_post');?>" method="post">
			<div class="tabbable">
		          ...
		          <div class="tab-pane active" id="A">
						<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="etitle" value=""><span class="form-required">*</span>
								</div>
							</div>
						</fieldset>
		          </div>
