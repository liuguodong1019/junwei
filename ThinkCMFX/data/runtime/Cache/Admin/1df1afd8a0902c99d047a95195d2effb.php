...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo U('Question/truesubjective');?>"target="_self">添加主观试题</a></li>
</ul>
<form class="form-horizontal js-ajax-form" action="<?php echo U('Question/truesubjectiveadd');?>" method="post">
	<div>
    ...
    <div class="table_full" style="border-bottom:solid #2c3e50 2px!important;">
        <table width="100%" cellpadding="2" cellspacing="2">
            ...
            <tr>
                <th width="80">答案</th>
                <td>
                    <textarea name='answer[]' id='options' style='width:98%;height:150px;'></textarea>
                </td>
            </tr>
            <tr>
                <th width="80">考点</th>
