...
<div class="wrap J_check_wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('Live/lector');?>" target="_self">讲师列表</a></li>
        <li><a href="<?php echo U('Live/create_lector');?>">添加讲师</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('Live/lector');?>">
        名称：
        ...
        <div class="table_full">
            <table class="table table-hover table-bordered table-list">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('Live/update_lector',array('id'=>$vo['id']));?>"><?php echo L('EDIT');?></a>|
                            <a href="<?php echo U('Live/delete',array('id'=>$vo['id']));?>"
                               class="js-ajax-delete"><?php echo L('DELETE');?></a>
                        </td>
                    </tr><?php endforeach; endif; ?>
            </table>
            <div class="table-actions">
                <button class="btn btn-danger" type="submit" data-action="<?php echo U('Live/delete');?>"
                        data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?>
                </button>
            </div>
