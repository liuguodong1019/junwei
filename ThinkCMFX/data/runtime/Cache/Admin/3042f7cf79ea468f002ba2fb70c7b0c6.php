...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('People/show');?>">适用人群列表</a></li>
        <li><a href="<?php echo U('People/create');?>">添加适用人群</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('People/show');?>">
        适用人群名称：
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                    <td><input type="checkbox" class="js-check" data-yid="js-check-y" data-xid="js-check-x"
                               name="p_ids[]" value="<?php echo ($vo["p_id"]); ?>"></td>
                    <td><a><?php echo ($vo["p_id"]); ?></a></td>
                    <td><?php echo ($vo["people"]); ?></td>
                    <td><?php echo (date("Y-m-d H:i:s",$vo['create_time'] )); ?></td>
                    <td><?php echo (date("Y-m-d H:i:s",$vo['update_time'] )); ?></td>
                    <td>
                        <a href="<?php echo U('People/update',array('id'=>$vo['p_id']));?>"><?php echo L('EDIT');?></a>|
                        <a href="<?php echo U('People/delete',array('id'=>$vo['p_id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>
                    </td>
                </tr><?php endforeach; endif; ?>

        </table>
        <div class="table-actions">
            <button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('People/delete');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
        </div>
