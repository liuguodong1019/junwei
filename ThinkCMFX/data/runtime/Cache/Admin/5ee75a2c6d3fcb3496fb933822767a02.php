...
<ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo U('Live/update_lector');?>"  target="_self">修改讲师</a></li>
    <li><a href="<?php echo U('Live/create_teaching');?>">添加授课类型</a></li>
</ul>

<form action="<?php echo U('Live/update_lector');?>" method="post">
