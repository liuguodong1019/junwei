...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
	        <li class="active"><a href="#A" data-toggle="tab">密卷编辑</a></li>
	    </ul>
		<form class="form-horizontal js-ajax-form" action="<?php echo U('Types/exclusiveedit_post');?>" method="post">
			<div class="tabbable">
		          ...
		          <div class="tab-pane active" id="A">
						<fieldset>
							...
							<div class="control-group">
								<label class="control-label">密卷标题</label>
								<div class="controls">
									<input type="text" name="etitle" value="<?php echo ($ex["etitle"]); ?>"><span class="form-required">*</span>
									<input type="hidden" name="ex_id" value="<?php echo ($ex["ex_id"]); ?>">
								</div>
							</div>
						</fieldset>
		          </div>
