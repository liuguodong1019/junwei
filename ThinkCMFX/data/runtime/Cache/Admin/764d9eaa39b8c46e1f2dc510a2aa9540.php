...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo U('Question/itembankedit');?>"  target="_self">试题修改</a></li>
</ul>
    ...
    <div class="table_full">
        <table width="100%" cellpadding="2" cellspacing="2">
			...
			<tr>
                <th width="80">题号</th>
                <td>
                    <input type="text" autocomplete="off" name="no" value="<?php echo ($item["no"]); ?>" style="width: 100px"/>
                </td>
            </tr>
            <tr>
                <th width="80">题干</th>
            ...
            <tr>
			 ...
			 <tr>
                <th width="80">考点</th>
                <td>
                    <input type="text" autocomplete="off"  name="point" style='width:98%;' value="<?php echo ($item["point"]); ?>" />
                </td>
            </tr>
            <tr>
                <th width="80">试题解析</th>
            ...
            <tr>
                <th width="80">分值</th>
                <td>
                    <input type="text" autocomplete="off" value="<?php echo ($item["score"]); ?>" name="score" />
                </td>
            </tr>
			<tr>
                <th width="80">试题描述</th>
