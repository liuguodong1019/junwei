...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Types/exclusive');?>">密卷管理</a></li>
			<li><a href="<?php echo U('Types/exclusiveadd');?>">密卷添加</a></li>
		</ul>
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Types/exclusivedelete');?>" data-subcheck="true" data-msg="<?php echo L('DELETE_CONFIRM_MESSAGE');?>"><?php echo L('DELETE');?></button>
			</div>
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($exclusive)): foreach($exclusive as $key=>$vo): ?><tr>
					<td><input type="checkbox" class="js-check" data-yid="js-check-y" data-xid="js-check-x" name="ex_ids[]" value="<?php echo ($vo["ex_id"]); ?>"></td>
					<td><a><?php echo ($vo["ex_id"]); ?></a></td>
					<td><?php echo ($vo["etitle"]); ?></td>
					<td><?php echo (date('Y-m-d H:i:s',$vo["etime"])); ?></td>
					<td>
						<a href="<?php echo U('Types/exclusiveedit',array('id'=>$vo['ex_id']));?>"><?php echo L('EDIT');?></a>|
						<a href="<?php echo U('Types/exclusivedelete',array('id'=>$vo['ex_id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>
					</td>
			...
			<div class="table-actions">
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Types/exclusivedelete');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
