...
<form action="<?php echo U('ClassHour/add');?>" class="well form-search" method="post" >
                ...
                <tr>
                    ...
                    <td>
                        <select name="course_id"  class="normal_select">
                            ...
                            <?php if(is_array($rew)): foreach($rew as $key=>$value): ?><option value="<?php echo ($value["id"]); ?>"><?php echo ($value["course_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
