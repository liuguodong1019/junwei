    ...
    <div class="table_full">
        <table width="100%" cellpadding="2" cellspacing="2">
            <tr>
                <th width="80">试卷名称</th>
                <td>
                    <input type="text" name="eid" value="<?php echo ($item["eid"]); ?>" style="width: 100px"/>年司国家司法考试试题
                </td>
            </tr>
            <tr>
                <th width="80">试卷类型</th>
                <td>
                    <select name="etid" class="normal_select">
                        <option value="0" <?php if($item["te_type"] == 0): ?>selected<?php endif; ?>>卷一</option>
                        <option value="1" <?php if($item["te_type"] == 1): ?>selected<?php endif; ?>>卷二</option>
                        <option value="2" <?php if($item["te_type"] == 2): ?>selected<?php endif; ?>>卷三</option>
                    </select>
                </td>
            </tr>
             <tr>
