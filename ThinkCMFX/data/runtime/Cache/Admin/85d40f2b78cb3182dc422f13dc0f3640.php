            ...
            <tr>
                ...
                <td>
                    <select name="etid" class="normal_select">
                        <option <?php if($item["te_type"] == 0): ?>selected<?php endif; ?>>卷一</option>
                        <option <?php if($item["te_type"] == 1): ?>selected<?php endif; ?>>卷二</option>
                        <option <?php if($item["te_type"] == 2): ?>selected<?php endif; ?>>卷三</option>
                    </select>
                </td>
            </tr>
             <tr>
