        ...
        <div class="box-body">
            <table width="100%" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <th width="80">课堂类型</th>
                    <td>
                        <?php if(($data["is_free"] == 0)): ?><label><input name="type" type="radio" value="<?php echo ($data["type"]); ?>" checked/>&nbsp&nbsp&nbsp大讲堂
                            ...
                            <label><input name="type" type="radio" value="<?php echo ($data["type"]); ?>"/>&nbsp&nbsp&nbsp大讲堂
                                <input name="type" type="radio" value="<?php echo ($data["type"]); ?>" checked/>&nbsp&nbsp&nbsp小班课 </label><?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <th width="80">是否实时</th>
                ...
                <tr>
                    <th width="80">收否收费</th>
                    <td>
                        <?php if(($data["is_free"] == 1)): ?><label><input name="is_free" type="radio" value="<?php echo ($data["is_free"]); ?>" checked/>&nbsp&nbsp&nbsp公开课
                            ...
                            <label><input name="is_free" type="radio" value="<?php echo ($data["is_free"]); ?>"/>&nbsp&nbsp&nbsp公开课
                                <input name="is_free" type="radio" value="<?php echo ($data["is_free"]); ?>" checked/>&nbsp&nbsp&nbspvip </label><?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <th width="80">课时数量</th>
