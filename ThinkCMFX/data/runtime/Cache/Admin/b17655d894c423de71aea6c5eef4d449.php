...
<ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo U('Book/create');?>"  target="_self">添加配发图书</a></li>
    <li ><a href="<?php echo U('Book/show');?>"  target="_self">配发图书</a></li>

</ul>
<!--<div class="wrap js-check-wrap">-->
<form action="<?php echo U('Book/create');?>" class="well form-search" method="post" >
    <!--<div class="col-auto">-->
        ...
        <div class="box-body">
            <table width="100%" cellpadding="2" cellspacing="2" >
                <tr>
                    <th width="80">图书名称</th>
                    <td>
                        <input type="text" name="book" value="" style="width: 300px" placeholder = "请填写名称"/>
                    </td>
                </tr>
            </table>
        </div>
