...
<ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo U('Order/create');?>"  target="_self">手动录入用户信息</a></li>
    <li ><a href="<?php echo U('Order/show');?>"  target="_self">订单列表</a></li>

</ul>
<form action="<?php echo U('Order/create');?>" enctype="multipart/form-data" class="well form-search" method="post" >
        ...
        <div class="box-body">
            <table width="100%" cellpadding="2" cellspacing="2" >
                <tr>
                    <th width="80">用户昵称</th>
                    <td>
                        <input type="text" name="user_nicename" value="" style="width: 300px"/>
                    </td>
                </tr>
                <tr>
                    <th width="80">手机号</th>
