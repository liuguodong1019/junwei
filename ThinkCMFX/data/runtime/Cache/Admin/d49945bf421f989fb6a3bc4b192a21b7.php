...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
	        <li class="active"><a href="#A" data-toggle="tab">科目添加</a></li>
	    </ul>
		<form class="form-horizontal js-ajax-form" action="<?php echo U('Types/classadd_post');?>" method="post">
			<div class="tabbable">
		          ...
		          <div class="tab-pane active" id="A">
						<fieldset>
						  <!--  <div class="control-group">
								...
								<div class="controls">
									<select name="pid">
                                      <?php if(is_array($pr)): foreach($pr as $key=>$vo): ?><option value="<?php echo ($vo["pid"]); ?>"><?php echo ($vo["ptitle"]); ?></option><?php endforeach; endif; ?>>
									</select>
								</div>
							</div> -->
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="stitle" value=""><span class="form-required"></span>
								</div>
							</div>
						</fieldset>
		          </div>
