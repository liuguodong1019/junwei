...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
	        <li class="active"><a href="#A" data-toggle="tab">章节添加</a></li>
	    </ul>
		<form class="form-horizontal js-ajax-form" action="<?php echo U('Types/chapteradd_post');?>" method="post">
			<div class="tabbable">
						...
						<fieldset>
						   <div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="ctitle" value=""><span class="form-required"></span>
								</div>
							</div>
						</fieldset>
		          </div>
