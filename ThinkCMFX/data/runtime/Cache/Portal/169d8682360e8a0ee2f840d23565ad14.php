...
<body>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:upload_one_image('图片上传','#thumb');">
										<img src="/junwei/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb-preview" width="135" style="cursor: hand" />
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb-preview').attr('src','/junwei/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/junwei/public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/junwei/public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
