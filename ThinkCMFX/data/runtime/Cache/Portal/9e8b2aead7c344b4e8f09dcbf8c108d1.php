		...
		$(function() {
			...
			Wind.use('ajaxForm', 'artDialog', 'iframeTools', function() {
				...
				$('.js-articles-copy').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/junwei/index.php?g=portal&m=AdminPost&a=copy&ids="+ ids, {
						title : "批量复制",
						width : "300px"
					});
				});
				...
				$('.js-articles-move').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/junwei/index.php?g=portal&m=AdminPost&a=move&old_term_id=<?php echo ((isset($term["term_id"]) && ($term["term_id"] !== ""))?($term["term_id"]):0); ?>&ids="+ ids, {
						title : "批量移动",
						width : "300px"
					});
				});
